...
public class FranquiciaController {
	...
	public ResponseEntity<Object> listaFranquicia() {
		...
		genericResponse = new GenericResponseDTO(this.franquiciaServices.getFranquicias(), true,
				FranquiciaConstants.RESPONSE_FIND, HttpStatus.OK, FranquiciaConstants.TITTLE_FIND);
